...
class PageSeeder extends BasePageSeeder
{
    public function run(): void
    {
        ...
        $homepage->update(['content' =>
            Html::tag('div', '[hero-intro title="All Catholic Media — Watch, Learn, Pray" show_cards="yes"][/hero-intro]') .
            ...
            Html::tag('div', '[latest-daily-rosary title="Pray the Daily Rosary" subtitle="Pray with the Church"][/latest-daily-rosary]') .
