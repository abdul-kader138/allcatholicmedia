...
class CatholicSaintsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $saints = [
            [
                'name'        => 'St. Francis of Assisi — Patron of Animals and Ecology', 'feast_date' => '10-04',
            ...
            [
                'name'        => 'St. Thomas Aquinas — Doctor Angelicus', 'feast_date' => '01-28',
            ...
            [
                'name'        => 'St. Joan of Arc — Maid of Orléans', 'feast_date' => '05-30',
            ...
            [
                'name'        => 'St. John Paul II — The Great Pilgrim Pope', 'feast_date' => '10-22',
            ...
            [
                'name'        => 'St. Faustina Kowalska — Apostle of Divine Mercy', 'feast_date' => '10-05',
            ...
            [
                'name'        => 'St. Augustine of Hippo — Doctor of Grace', 'feast_date' => '08-28',
            ...
            [
                'name'        => 'St. Thérèse of Lisieux — The Little Flower', 'feast_date' => '10-01',
            ...
            [
                'name'        => 'St. Padre Pio — Stigmatist of the 20th Century', 'feast_date' => '09-23',
            ...
            [
                'name'        => 'St. Catherine of Siena — Doctor of the Church', 'feast_date' => '04-29',
        ...
        foreach ($saints as $data) {
            $existing = Post::query()->where('name', $data['name'])->first();
            if ($existing) {
                MetaBox::saveMetaBoxData($existing, 'feast_date', $data['feast_date']);
                continue;
            }
            ...
            MetaBox::saveMetaBoxData($post, 'feast_date', $data['feast_date']);
            $added++;
        }
