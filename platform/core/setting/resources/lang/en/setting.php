...
return [
    ...
    'phone_number' => [
        ...
        'max_length_helper' => 'Maximum number of characters allowed for phone numbers.',
        'note_content' => '<p class="mb-1"><strong>For local format (without country code):</strong> Set min/max based on your country\'s phone number length (e.g., 8-15 for most countries).</p><p class="mb-0"><strong>For international format (with country code enabled):</strong> Recommended min: 7, max: 20. This accommodates country codes (1-4 digits) + phone numbers (typically 6-15 digits).</p>',
    ],
