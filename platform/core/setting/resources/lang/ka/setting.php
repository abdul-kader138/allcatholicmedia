...
return [
    ...
    'email' => [
        ...
        'queue_warning_title' => 'Queue Configuration Required',
        'queue_warning_description' => 'Your email queue is currently configured to use ":default" driver, but your queue worker may not be running. This means emails will not be sent until you set up a queue worker.',
        'queue_warning_action' => 'To send emails immediately without a queue worker, set QUEUE_CONNECTION=sync in your .env file. Otherwise, ensure your queue worker is running with "php artisan queue:work". <a href="https://laravel.com/docs/12.x/queues" target="_blank" rel="noopener">Learn more about Laravel Queues</a>.',
        ...
        'mail_gun_secret_placeholder' => 'Ex: your-mailgun-key-here',
    ...
    'phone_number' => [
        ...
        'max_length_helper' => 'Maximum number of characters allowed for phone numbers.',        'note_content' => '<p class="mb-1"><strong>ადგილობრივი ფორმატისთვის (ქვეყნის კოდის გარეშე):</strong> დააყენეთ მინ/მაქს თქვენი ქვეყნის ტელეფონის ნომრის სიგრძის საფუძველზე (მაგ., 8-15 უმეტეს ქვეყნებში).</p><p class="mb-0"><strong>საერთაშორისო ფორმატისთვის (ქვეყნის კოდით ჩართული):</strong> რეკომენდებული მინ: 7, მაქს: 20. ეს მოიცავს ქვეყნის კოდებს (1-4 ციფრი) + ტელეფონის ნომრებს (როგორც წესი 6-15 ციფრი).</p>',
    ],
];
