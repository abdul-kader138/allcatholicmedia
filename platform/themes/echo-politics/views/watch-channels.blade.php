...
.acm-watch-hero.has-bg-img::before{
...
/* Radial gold glow — only when no bg image */
.acm-watch-hero:not(.has-bg-img)::before{
...
<div class="acm-watch-page">
    <section class="acm-watch-hero {{ $heroImage ? 'has-bg-img' : '' }}"
