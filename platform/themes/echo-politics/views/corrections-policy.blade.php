...
<div class="acm-policy-page">
    <div class="acm-policy-inner">
        ...
        <p>{{ __('Please use our contact page to report a factual error, incorrect date, broken source link, misleading headline, or attribution issue. Include the page URL and a brief explanation of the correction needed.') }} <a href="{{ url('/contact') }}">{{ __('Contact the editorial team') }}</a>.</p>
...
.acm-policy-page a{color:#f3d46d;text-decoration:underline;text-underline-offset:3px}
</style>
