...
Route::group(['middleware' => ['web', 'core']], function (): void {
    ...
    */
    ...
    Route::get('watch', function () {
        ...
        return Theme::scope('watch-channels', compact('channels', 'heroImage'))->render();
    })->name('public.watch');
    ...
    */
    Route::get('listen', function (Request $request) {
        ...
        return Theme::scope('listen-shows', compact('shows', 'categories', 'category', 'sort', 'heroImage'))->render();
    })->name('public.listen');
    ...
    */
    ...
    Route::get('prayer-request', [PrayerRequestController::class, 'show'])->name('public.prayer-request');
    Route::post('prayer-request', [PrayerRequestController::class, 'store'])->name('public.prayer-request.store');
